...
all_data_java = get_all_data(filenames_service1, "/Java/Service1")
all_data_python = get_all_data(filenames_service1, "/Python/Service1")
all_data_go = get_all_data(filenames_service1, "/Go/Service1")
...
get_all_graphs_in_metrics(java_stats, python_stats, go_stats, java_titles, python_titles, go_titles, metrics, "Service1")

print("service 1 done")
#does graphing service2
#======================================#
#======================================#
all_data_java = get_all_data(filenames_service2,  "/Java/Service2")
all_data_python = get_all_data(filenames_service2, "/Python/Service2")
all_data_go = get_all_data(filenames_service2, "/Go/Service2")


java_stats, java_titles=fill_data(all_data_java)
python_stats, python_titles=fill_data(all_data_python)
go_stats, go_titles=fill_data(all_data_go)
get_all_graphs_in_metrics(java_stats, python_stats, go_stats, java_titles, python_titles, go_titles, metrics, "Service2")
#======================================#
#======================================#

#does graphing service3
all_data_java = get_all_data(filenames_service3, "/Java/Service3")
all_data_python = get_all_data(filenames_service3, "/Python/Service3")
all_data_go = get_all_data(filenames_service3, "/Go/Service3")
...
get_all_graphs_in_metrics(java_stats, python_stats, go_stats, java_titles, python_titles, go_titles, metrics, "Service3")
#======================================#
#======================================#

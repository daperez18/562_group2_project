...
time output=`aws lambda invoke --invocation-type RequestResponse --function-name  ServiceOne --region us-east-1 --payload $json2 /dev/stdout | head -n 1 | head -c -2 ; echo`
